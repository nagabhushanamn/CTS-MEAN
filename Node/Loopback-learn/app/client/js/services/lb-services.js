  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Product#status
         * @methodOf lbServices.Product
         *
         * @description
         *
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Review.publisherId() instead.
        "prototype$__get__publisherId": {
          url: urlBase + "/Reviews/:id/publisherId",
          method: "GET"
        },
    ...
    */
    R.modelName = "Review";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Review#publisherId
         * @methodOf lbServices.Review
         *
         * @description
         *
         * Fetches belongsTo relation publisherId.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.publisherId = function() {
          var TargetResource = $injector.get("Reviewer");
          var action = TargetResource["::get::Review::publisherId"];
          return action.apply(R, arguments);
        };
